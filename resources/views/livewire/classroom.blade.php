...
{{--            </div>--}}
            ...
            <div class="mt-7 text-gray-900 dark:text-gray-100">
                <a href="{{ route('classrooms.create') }}" class="py-3 inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-500 active:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                    {{ __('global.add_student_to_classroom') }}
                </a>
            </div>
            @endadmin
        </div>
