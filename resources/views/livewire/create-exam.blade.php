                ...
                <div class="w-full sm:max-w-md bg-white dark:bg-gray-800 overflow-hidden sm:rounded-lg">
                    <form wire:submit.prevent="store">
                        ...
                        <div class="mt-4">
                            ...
                            <select wire:model="classroom_id" id="classroom_id" name="classroom_id" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input wire:model="score" id="score" class="block mt-1 w-full" type="number" name="score" :value="old('score')" :placeholder="__('global.score')"/>
