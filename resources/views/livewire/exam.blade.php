    ...
    <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tr>
                ...
                <th scope="col" class="py-3 px-6">{{ __('global.class_year') }}</th>
                <th scope="col" class="py-3 px-6">{{ __('global.score') }}</th>
            ...
            @forelse($exams as $exam)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $exam->full_name }}</th>
                    <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $exam->lesson }}</th>
                    <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $exam->class_year }}</th>
                    <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $exam->score }}</th>
                    <td class="py-4 px-6">
            ...
            @empty
                <tr>
                    <td class="py-4 px-6">
                        <span class="font-medium dark:text-white">لاتوجد اختبارات</span>
                    </td>
                </tr>
            @endforelse
            </tbody>
